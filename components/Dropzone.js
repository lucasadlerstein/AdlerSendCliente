...
const DropZone = () => {
    ...
    const maxSize = autenticado ? 1024*1024*1536 : 1024*1024*10;

    // Extrar contenido de dropzone
    const {getInputProps, getRootProps, isDragActive, acceptedFiles } = useDropzone({onDropAccepted, onDropRejected, maxSize });
